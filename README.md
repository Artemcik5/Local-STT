...
model -if you want english only, add .en at the end so example: "small.en" otherwise leave it as it is,<br>
...
-for problems with the whisper library, i recommend going to their <a href="https://github.com/openai/whisper" Github page> Github page.</a>

### Notes
Thank you for viewing the page.
